...
HEALTH_FONT = pygame.font.SysFont('lexend', 40)
WINNER_FONT = pygame.font.SysFont("lexend", 100)
...
def main():
    ...
    run = True
    while run:
        clock.tick(FPS) # controls the speed of the loop. It's a capped framerate 
